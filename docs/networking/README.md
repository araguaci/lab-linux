...
category: networking
tags: [networking, infrastructure, nginx, proxy, devops, servers]
---
...
### Proxy e Web Servers
- **[nginx-redirecionamentos-www.md](nginx-redirecionamentos-www.md)** - Configurar redirecionamentos WWW no Nginx
- **[Proxmox-onboarding-after-the-Installation.md](Proxmox-onboarding-after-the-Installation.md)** - Setup de Proxmox

### Gerenciamento de Rede
- **[networkmanager-nmcli-ubuntu-debian.md](networkmanager-nmcli-ubuntu-debian.md)** - NetworkManager em Ubuntu/Debian
- **[networkmanager-rhel-centos-8.md](networkmanager-rhel-centos-8.md)** - NetworkManager em RHEL/CentOS
