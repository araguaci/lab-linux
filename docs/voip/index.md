...
### Plataformas
- [issabel-debian-12-asterisk.md](issabel-debian-12-asterisk.html) - Issabel com Asterisk 20 em Debian 12

### Aplicações para Raspberry Pi
- [freepbx-raspberry-pi.md](../raspberry-pi/freepbx-raspberry-pi.html) - FreePBX no Raspberry Pi
- [asterisk-raspberry-pi.md](../raspberry-pi/asterisk-raspberry-pi.html) - Asterisk no Raspberry Pi
