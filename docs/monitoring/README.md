...
category: monitoring
tags: [monitoring, observability, zabbix, diagnostics, performance]
---
...
- **[processos-devorador-cpu-linux.md](processos-devorador-cpu-linux.md)** - Identificar processos que consomem CPU
- **[httptap-monitorar-http-https.md](httptap-monitorar-http-https.md)** - Monitorar tráfego HTTP/HTTPS

### Plataformas de Monitoramento
- **[zabbix-725-debian-12.md](zabbix-725-debian-12.md)** - Instalação do Zabbix 7.2.5 em Debian 12
...
- Configurar alertas apropriados (não muito sensível nem insensível)
- Manter histórico de dados por pelo menos 6 meses
- Revisar metricas regularmente
- Atualizar thresholds conforme crescimento
